...
class AppPrefs(context: Context) {
    ...
    var playerGestureDirectionReversed: Boolean
        get() = prefs.getBoolean(KEY_PLAYER_GESTURE_DIRECTION_REVERSED, false)
        set(value) = prefs.edit().putBoolean(KEY_PLAYER_GESTURE_DIRECTION_REVERSED, value).apply()
    ...
    companion object {
        ...
        private const val KEY_PLAYER_GESTURE_DIRECTION_REVERSED = "player_gesture_direction_reversed"
